...
const SelectLocation = ({position,setPosition,setShowMap,setLocationName}) => {
  const center = {
    lat: 51.505,
    lng: -0.09,
  }
...
<div className='absolute bottom-0 right-0 z-50 flex '>
    ...
    <MapContainer center={center} zoom={13} scrollWheelZoom={true}  className='h-[400px] rounded-xl '>
       <LocationFinderDummy />
      <TileLayer
