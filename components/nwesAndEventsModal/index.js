        ...
        <>
          ...
          >
            ...
            <div className="w-2/6 flex items-center   justify-center">
                  ...
                  Date : {props.modalDetails.date}<br/>Timing : {props.modalDetails.fromTime}-{props.modalDetails.toTime}
                  </h4>
                  <button
                ...
                <div className=" whitespace-pre-wrap relative p-6 sm:p-2 flex-auto overflow-y-scroll">
                    ...
                    <p className=" text-slate-500 text-justify sm:my-0 text-lg sm:text-sm leading-relaxed">
                    {props.modalDetails.shortDescription} 
                    </p>
