...
<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="flex-shrink-0 h-6 w-6 text-[#F07C00]">
  <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
                    ...
                    className={
                        subNav === true
                        ? "transform -rotate-90 ml-[202px] h-5 w-5 text-gray-400 group-hover:text-gray-500 transition ease-out duration-200"
                        : "transform rotate-0 transition ease-out duration-200 ml-[202px] h-5 w-5 text-gray-400 group-hover:text-gray-500"
                    }
            ...
            <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                ...
                <a
                    href="documents/academics/internship-policy/kit-internship-policy-2020.pdf"
                    className="-m-3 p-3 flex items-start rounded-lg hover:bg-gray-50"
                >
                ...
                <a
                    href="documents/academics/internship-policy/guidelines-for-internship-and-project-accounted-throgh-kite.pdf"
                    className="-m-3 p-3 flex items-start rounded-lg hover:bg-gray-50"
                >
