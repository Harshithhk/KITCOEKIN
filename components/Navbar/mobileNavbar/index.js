    ...
    return (
        <div className="absolute top-0 left-0 w-screen h-screen ">
          ...
          <ul className="z-20 ">
            ...
            <li onClick={() => (setNav1(!nav1))} className={nav2 || nav3 ?"hidden":""}>
              <About nav1 = {nav1} />
            </li>
            <li onClick={() => (setNav2(!nav2))} className={ nav1 || nav3 ?"hidden":""}>
              <Admissions nav1 = {nav1}  nav2 = {nav2} />
            </li>
            <li  onClick={() => (setNav3(!nav3))} className={nav2 || nav1 ?"hidden":""}>
              <Departments nav1 = {nav1}  nav3 = {nav3} />
            </li>
            <li className={nav2 || nav1 || nav3?"hidden":""}>
            ...
            <SubNavList nav1 = {nav1} nav2 = {nav2}  nav3 = {nav3} />
        </ul>
          </div>
