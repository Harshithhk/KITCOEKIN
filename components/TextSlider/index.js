      ...
      >
        <div className="relative flex flex-col justify-center w-full sm:py-8 2xl:py-24 bg-primary 2xl:w-1/2 sm:w-full item-center">
          ...
          <div className="absolute bottom-0 right-0 hidden mb-4 mr-4 2xl:block">
            <button className="w-12 h-10 font-bold text-gray-500 bg-gray-100 border-r rounded-l-full focus:outline-none hover:text-indigo-500">
              &#8592;
            </button>
            <button className="w-12 h-10 font-bold text-gray-500 bg-gray-100 rounded-r-full focus:outline-none hover:text-indigo-500">
              &#8594;
            </button>
          </div>
        </div>
        ...
        <div className="bg-white 2xl:w-1/2 sm:w-full">
          <div className="relative flex flex-col h-full">
            ...
            <div className="relative z-10 h-full">
              ...
              Number of Students:
              <span className="ml-8 italic font-semibold text-primary serif sm:text-xl 2xl:text-2xl" >
                05
              </span>
            </p> */}
                <p className="ml-8 italic font-normal text-gray-400 serif sm:px-6 sm:py-6 2xl:px-16 sm:text-xl 2xl:text-2xl">
                ...
                <p className="ml-8 italic font-normal text-gray-400 serif sm:px-6 sm:py-6 2xl:px-16 sm:text-xl 2xl:text-2xl">
                  Package:
                  <span className="ml-8 italic font-semibold text-primary serif sm:text-xl 2xl:text-2xl">
                    <span className="font-bold"> 90 LPA </span>- AY 2021-22
                  </span>
                </p>
              </div>

              {/* <div >
            <p className="px-6 py-6 text-xl italic font-normal text-gray-600 serif 2xl:px-16 2xl:py-10 2xl:text-2xl" >
          ...
          <div >
            ...
            <div className="flex items-center justify-center my-4">
              {/* <button  className="inline-block mx-2 font-bold text-center rounded-full shadow-xs focus:outline-none focus:shadow-outline"  >JD</button> */}
              <img
                data-aos="zoom-in"
                data-aos-delay="0"
                src="/images/recruiters/adani.jpg"
                className=""
                alt=""
              />
              {/* <button  className="inline-block w-12 h-12 mx-2 font-bold text-center bg-indigo-100 rounded-full shadow-xs focus:outline-none focus:shadow-outline" >JW</button> */}
            </div>

            <div className="flex justify-center px-6 pt-2 pb-6 2xl:py-6">
              {/* <div className="text-center" x-show="testimonialActive == 1">
            <h2 className="text-sm font-bold leading-tight text-gray-700 2xl:text-base">John Doe</h2>
            <small className="text-xs text-gray-500 truncate 2xl:text-sm">CEO, ABC Inc.</small>
          </div> */}
            ...
            <h2 className="text-sm font-bold leading-tight text-gray-700 2xl:text-base">John Wick</h2>
            <small className="text-xs text-gray-500 truncate 2xl:text-sm">Product Manager, Fake Corp.</small>
          </div> */}
            </div>
          </div>
        </div>
