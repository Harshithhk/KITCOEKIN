...
const AchievementsCard = (props) =>{
  ...
  let stringLimit = 200
  let alumniByte = AchievementData.alumniByte
  ...
  if(props.readMore){
    alumniByte = AchievementData.alumniByte
  }
    ...
    return(
        <>
                <div className="grid grid-cols-4 sm:grid-cols-1">
                        ...
                        {AchievementData.photoUrl.length > 5?
                        <img className="w-full h-auto rounded" src={AchievementData.photoUrl.length>5?AchievementData.photoUrl:"images/awatar.png"} alt="Large avatar" />
                        :
                    ...
                    <div className="flex flex-col p-6 col-span-full row-span-full ">
                        ...
                        <div className="flex items-center justify-between pt-2">
                            <div className="flex space-x-2">
                                ...
                                <span className="self-center text-sm"> {AchievementData.name}</span>
                            </div>
                            <span className="text-xs">{AchievementData.time}</span>
                        </div>
                    </div>
                </div>
                </div>
