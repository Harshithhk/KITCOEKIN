  ...
  <section className="mb-32 text-gray-800 text-center w-[500px] ">
    ...
    <div className="grid gap-x-6 lg:gap-x-12 md:grid-cols-3">
      <div className="mb-24 md:mb-0">
        <div className="rounded-lg shadow-lg h-full block bg-black">
          <div className="flex justify-center">
            <div className="flex justify-center mt-[-75px]">
              <img src="https://mdbootstrap.com/img/new/avatars/6.jpg" className="rounded-full mx-auto shadow-lg w-[150px]" alt=""  />
            </div>
          </div>
          <div className="p-6">
      ...
      <div className="mb-24 md:mb-0">
        <div className="rounded-lg shadow-lg h-full block bg-white">
          <div className="flex justify-center">
            <div className="flex justify-center mt-[-75px]">
              <img src="https://mdbootstrap.com/img/new/avatars/8.jpg" className="rounded-full mx-auto shadow-lg w-[150px]" alt=""  />
            </div>
          </div>
          <div className="p-6">
      ...
      <div className="">
        <div className="rounded-lg shadow-lg h-full block bg-white">
          <div className="flex justify-center">
            <div className="flex justify-center mt-[-75px]">
              <img src="https://mdbootstrap.com/img/new/avatars/15.jpg" className="rounded-full mx-auto shadow-lg w-[150px]" alt=""  />
            </div>
          </div>
          <div className="p-6">
