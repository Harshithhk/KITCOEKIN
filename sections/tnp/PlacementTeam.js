...
const PlacementTeam = () => {
  ...
  return (
    <section className="relative  z-30 w-full mx-auto pt-16 sm:pt-14 sm:-mt-2 pb-20 h-fit bg-[#F8F7FC] px-14 sm:px-4 sm:pb-10">
      ...
      <div className="flex items-center justify-center h-16 px-16 mt-12 text-xl text-right rounded-lg shadow-lg text-slate-500 sm:text-base sm:px-2 w-fit">
      ...
      <div className="flex flex-wrap justify-center w-full mt-16 gap-x-16 gap-y-16 sm:mt-14 sm:gap-x-7 sm:gap-y-7">
        {placementTeam.map((image, index) => (
          <div
            key={index}
            className="z-30 shadow-sm w-[190px] h-fit sm:w-[120px] flex flex-col items-center justify-center  rounded-lg overflow-hidden "
          >
            <img
              src={image.img}
              className="w-full h-fit sm:h-fit  rounded-lg overflow-hidden border-[1px] border-accent border-b-0"
              alt={image.img}
            />
      ...
      <div className="flex items-center justify-center h-16 px-16 mx-auto mt-12 text-xl text-right rounded-lg shadow-lg text-slate-500 sm:text-base sm:px-2 w-fit">
        Our Staff
      </div>
      <div className="flex flex-wrap justify-center w-full mt-16 gap-x-16 gap-y-16 sm:mt-14 sm:gap-x-7 sm:gap-y-7">
        {OurStaff.map((image, index) => (
          <div
            key={index}
            className="shadow-sm z-30 w-[190px] h-fit sm:w-[120px] flex flex-col items-center justify-center  rounded-lg overflow-hidden "
          >
            <img
              src={image.img}
              className="w-full h-fit sm:h-fit  rounded-lg overflow-hidden border-[1px] border-accent border-b-0 "
