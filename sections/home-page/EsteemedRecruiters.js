...
const EsteemedRecruiters = () => {
  let recruiters = [
    ...
    "/images/recruiters/recruiters-02.png",
    "/images/recruiters/recruiters-03.png",
    "/images/recruiters/recruiters-04.png",
    "/images/recruiters/recruiters-05.png",
    "/images/recruiters/recruiters-06.png",
    "/images/recruiters/recruiters-07.png",
    "/images/recruiters/recruiters-08.png",
    "/images/recruiters/recruiters-09.png",
    "/images/recruiters/recruiters-10.png",
    "/images/recruiters/recruiters-11.png",
    "/images/recruiters/recruiters-12.png",
    "/images/recruiters/recruiters-13.png",
    "/images/recruiters/recruiters-14.png",
    "/images/recruiters/recruiters-15.png",
    "/images/recruiters/recruiters-16.png",
    "/images/recruiters/recruiters-17.png",
    "/images/recruiters/recruiters-18.png",
  ]

  return (
    <section className="py-4 mt-16 -mb-20 bg-secondary ">
          ...
          <div className=" grid grid-cols-6 gap-5 divide-x-2 divide-y-2 backdrop-blur-[.5px] sm:backdrop-blur-0  h-full md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 md:gap-[20px]">
            {recruiters.map((element, index) => (
              <div
                ...
                data-aos="zoom-in"
                data-aos-delay="0"
                className={`overflow-hidden relative cursor-pointer place-self-center  hover:shadow-2xl hover:w-[190px] md:hover:w-[145px] rounded-[22px] h-[130px] w-[185px] bg-center  bg-no-repeat bg-cover  shadow-lg md:w-[145px] md:h-[105px]`}
              >
