...
function Hero1(props) {
  return (
    <>
      <div className=" rounded-tl-full md:hidden 2xl:block  float-right bg-[#edebf7] w-1/2 h-full">
        <div className="absolute right-72  "><span className=" animate-wiggle2 grid grid-cols-7 gap-4 ">
        ...
        <img data-aos="zoom-in"
            data-aos-delay="20" src=" images/HomePage/kitcoekbg.jpg " className="animate-wiggle2 z-20 block ml-8  mt-20 rounded-tr-full  h-[500px] " alt="" />
      </div>
 <img
