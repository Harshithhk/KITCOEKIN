...
function Hero2(props) {
    return (
        <>
              <img
        src="/images/HomePage/Hero/hero2.jpg"
        data-aos="zoom-in"
        data-aos-delay="20"
        ...
        <div className="mt-8 md:translate-x-0 relative">
          ...
          <div className="flex flex-col  gap-y-4 text-xl text-accent ml-8 w-auto mt-7 md:text-sm md:w-[280px] md:translate-x-0  md:p-1 md:text-center md:text-white">
            <div className='flex'>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" className='mx-2  h-7 w-7' fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" >
