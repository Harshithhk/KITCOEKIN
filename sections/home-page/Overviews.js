const Overviews = () => {
  return (
    <section className="bg-[#f2f2f0] p-[50px] pt-[60px] flex justify-between pr-[5%] xl:block  md:p-[0px] ">
      ...
      <div className="w-[719.46px] 1xl:w-[500px] md:w-[100%] md:h-[269px] md:mt-4 md:p-[4px] md:mx-auto">
        <div className="flex justify-between mb-[14px]">
          <div className="w-[227px] h-[244px] md:w-[116px] md:h-[128px] bg-[url(/images/AboutUs/about2.jpg)] bg-cover bg-center"></div>
          <div className=" 1xl:hidden xl:block w-[227px] h-[244px] md:w-[116px] md:h-[128px] bg-[url(/images/AboutUs/about5.jpg)] bg-center bg-cover"></div>
        ...
        <div className="flex justify-between ">
          ...
          <div className=" 1xl:hidden xl:block w-[227px] h-[244px] md:w-[116px] md:h-[128px] bg-[url(/images/AboutUs/about1.jpg)] bg-center bg-cover"></div>
