const Overviews = () => {
  return (
    <section className="bg-[#f2f2f0] p-[50px] pt-[60px] flex   justify-between pr-[5%] gap-2 lg:block  md:p-[0px] ">
      <section className="md:p-[16px] pb-10">
        ...
        <div className=" text-[#B94700] mt-8 text-justify md:mt-4  w-[516.36px] lg:w-[95%] text-[20.9842px] leading-[31.48px] tracking-[0.005em] font-normal md:will-change-contents md:mx-auto md:text-base">
      ...
      <div className="w-[719.46px] xl:w-[500px] md:w-[100%] mt-24 md:h-[269px] md:mt-4 md:p-[4px] md:mx-auto">
        ...
        <div className="flex justify-between ">
          <div className=" w-[227px] xl:w-[160px] xl:h-[160px] h-[244px] md:w-[116px] md:h-[128px] bg-[url(/images/AboutUs/about7.jpg)] bg-center bg-cover"></div>
          <div className=" 1xl:hidden xl:block w-[227px] xl:w-[160px] xl:h-[160px] h-[244px] md:w-[116px] md:h-[128px] bg-[url(/images/AboutUs/about1.jpg)] bg-center bg-cover"></div>
          <div className="w-[227px] xl:w-[160px] xl:h-[160px] h-[244px] md:w-[116px] md:h-[128px] bg-[url(/images/HomePage/Polygon.jpg)] bg-center bg-cover"></div>
        </div>
      </div>
    </section>
  )
