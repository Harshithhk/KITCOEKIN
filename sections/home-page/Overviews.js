...
const Overviews = () => {
  return (
    <section className="p-[50px] pt-[60px] flex justify-between pr-[5%] md:block  md:p-[0px] ">
      <section className='md:p-[16px]'>
        ...
        <div className=" text-[#B94700] mt-8 md:mt-4  w-[516.36px] md:w-[350px] text-[20.9842px] leading-[31.48px] tracking-[0.005em] font-normal md:will-change-contents md:mx-auto md:text-base">
        ...
        <div className="flex gap-[10px] mt-4 md:mt-2 text-[#3D3859] md:ml-0">
          <div
            className="italic  font-[#3D3859] font-bold underline text-[17.9865px] md:text-base  tracking-[0.005em]"
          >
            Read more
          </div>
