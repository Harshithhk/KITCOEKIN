  ...
  return (
    <div className="relative mt-24  md:hidden">
      ...
      <div className=" relative w-[986.24px] h-[542.52px] mt-12 m-auto  overflow-hidden font-poppins">
        <div className="">
          {/* double layer */}
          <div className="left-[210.67px]  bg-[url(/images/HomePage/statistics1.png)] absolute  w-[349.75px] h-[350.3px] bg-cover bg-center "></div>
          ...
          <div className="left-[624.26px] bg-[url(/images/HomePage/statistics2.png)] bg-center bg-cover absolute  w-[349.75px] h-[350.3px] "></div>
        ...
        <div className="">
          <div className="bg-[url(/images/HomePage/statistics2.png)] bg-center bg-cover absolute  w-[349.75px] h-[350.3px] bottom-0 "></div>
          ...
          <div className="left-[422.5px] bg-[url(/images/HomePage/statistics2.png)] bg-center bg-cover absolute  w-[349.75px] h-[350.3px] bottom-0 "></div>
