    ...
    return(
        <div className={`w-auto  rounded-xl p-6 sm:p-2 mt-2 flex flex-col items-start  sm:items-start`}>
          ...
          <QuickLinks>
            ...
            <QuickLinks.Plates href="dept-of-electronics-engg-faculty">Staff</QuickLinks.Plates>
            <QuickLinks.Plates href="dept-of-electronics-engg-laboratories">Laboratories</QuickLinks.Plates>
            ...
            <QuickLinks.Plates href="dept-of-electronics-engg-mous">MOU'S</QuickLinks.Plates>
            <QuickLinks.Plates href="dept-of-electronic-engg-po-peos">PO's & PEO'S</QuickLinks.Plates>
