  ...
  return (
    ...
    >
      ...
      <QuickLinks>
        ...
        <QuickLinks.Plates href="dept-of-mechanical-engg-laboratories">
          Laboratories
        </QuickLinks.Plates>
        <QuickLinks.Plates
          logo="dropDown"
        ...
        <QuickLinks.Plates href="dept-of-mechanical-engg-recruiters">
          Recruiters
        </QuickLinks.Plates>

        <QuickLinks.Plates href="dept-of-mechanical-engg-mous">
          MOU'S
        </QuickLinks.Plates>
        <QuickLinks.Plates href="dept-of-mechanical-engg-po-peos">
          PO's & PEO'S
        </QuickLinks.Plates>
        <QuickLinks.Plates
          logo="dropDown"
        ...
        <QuickLinks.Plates href="dept-of-mechanical-engg-news">
          Newsletter
        </QuickLinks.Plates>
      </QuickLinks>
    </div>
