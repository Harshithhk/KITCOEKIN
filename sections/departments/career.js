...
const Career = () => {
  ...
  return (
    ...
    <section className="mt-16 mx-auto  w-[1407px]  sm:w-full sm:mt-8 flex ">
      {/* HEADING */}
     ...
     <div className=" w-[750px] rounded-xl  p-6 sm:w-full ">
        ...
        <div className="mt-12 w-[700px] sm:w-full bg-transparent leading-[50px]  sm:mt-4">
          ...
          Data Structures,Computer Algorithms,Computer Network, Database Engineering, Operating Systems, MICROPROCESSOR
          </div>
          <div className="flex justify-between w-full p-4 mt-6 bg-[#F8F7FC] sm:text-sm sm:leading-normal sm:p-2">
          ...
          <div className="flex justify-between w-full p-4 mt-6 bg-[#F8F7FC] sm:leading-normal sm:text-sm sm:p-2">
      ...
      <div className="ml-[200px] -mt-[25px] min-w-[400px]">
                               ...
                               <div className="flex mt-2 mb-2">
                                ...
                                <hr></hr> 
                                    ...
                                    <div className={
                                      ...
                                      :  "flex mt-2 mb-2"
                                      } onMouseEnter ={() => (setSubLink(!subLink))} onMouseLeave ={() => (setSubLink(!subLink))} >
                                        <div className=" w-[90%] text-left pl-2 pr-2 text-slate-400">	Placement</div>
                                    ...
                                    <div className={
                                      ...
                                      "flex mt-2 mb-2 bg-[#F8F7FC]"
                                      :  "flex mt-2 mb-2"
                                      } onMouseEnter ={() => (setSubLink2(!subLink2))} onMouseLeave ={() => (setSubLink2(!subLink2))} >
                                        <div className=" w-[90%] text-left pl-2 pr-2 text-slate-400">	Internship</div>
                                        <div className=" w-[20%] text-left mr-2 pl-2 text-slate-400 ">	 
                                          <svg
                                                  className={
                                                    subLink2 === true
