  ...
  return (
    <section className="mt-16 mx-auto  w-[1407px] sm:w-full sm:mt-8 flex items-start justify-between">
      ...
      <div className=" w-[750px] rounded-xl bg-slate-50 p-6 sm:w-full">
        ...
        <div className="mt-12 w-[700px] sm:w-full leading-[54px] sm:mt-4">
          <div className="w-full h-12 rounded-t-md bg-[#20AD96] text-2xl text-white flex items-center px-4 sm:h-fit  sm:text-base sm:py-1">
            Multiple Platforms Supported for Teaching & Studying
          </div>
          <div className="w-full p-4 py-8 bg-white sm:leading-normal sm:text-sm sm:p-2">
          ...
          <div className="flex justify-between w-full p-4 mt-6 bg-white sm:text-sm sm:leading-normal sm:p-2">
          ...
          <div className="flex justify-between w-full p-4 mt-6 bg-white sm:leading-normal sm:text-sm sm:p-2">
