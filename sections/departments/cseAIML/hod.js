...
<p>       Computer science has become one of the fastest-growing engineering streams due to
   the tremendous rise of computer systems and their integration into all aspects of life
   . Whether it's a basic cell phone or a complex space shuttle, computers are present and
    play an important role in almost every aspect of life
</p><br/>
<p>         Artificial Intelligence (AI) is a relatively new and emerging field of computer 
  science that is rapidly expanding its horizons in areas such as healthcare, security,
   entertainment, education, autonomous transportation, intelligent robots, space exploration,
    speech processing, stock trading, and many others. Artificial intelligence (AI) and its
     applications have a tremendous impact on our lives.
     <br /><br />AI attempts to artificially instil intelligence in robots by simulating human intellect. 
     Machine learning (ML) is an AI application that aims to give machines the ability to learn 
     on their own. AI and machine learning are key drivers of digital transformation and have
     resulted in a slew of new career opportunities. Engineers who are versed in these technologies are in high demand.
</p>
