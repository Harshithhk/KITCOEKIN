...
<p>       Civil Engineering is one of the basic and core branches of Engineering, having a large influence on common man’s living. It emphasizes on the technical uplift of the common man and guides common man through application of the technical knowledge for the welfare of the society. Think of any technical activity and it is really impossible to forget the impact of CIVIL ENGINEERING on it.
  <br /><br />
...
<p>          
      ...
      <div className="md:mx-auto w-[300px] h-[370px] bg-transparent   mt-28 mr-6 rounded-xl text-white text-2xl md:text-xl  items-center justify-between flex flex-col md:mt-14">
        ...
        <div className="overflow-hidden relative bg-transparent sm:-mx-1 sm:-mt-1 ">
          <img src="images/department/civil/m-a-chavan.png " className=" " alt="mamtakalas.png" />
        </div>
