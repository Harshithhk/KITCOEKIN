...
<p>     It is my proud privilege to be the Head of Basic Sciences and Humanities Department
   at KIT’s College of Engineering (Autonomous), Kolhapur. Whenever people look at a tall
    building they always tend to see its top; in turn base gets neglected which is the actual
     balance of the building. Yes, first year of engineering is the base and we at BSH department
      strengthen that base. Being a ‘Foundation Stone’ of engineering academics, the department of 
      Basic Sciences, Humanities and Foreign Languages of the institute is well equipped with state-of
      -the-art infrastructure, highly qualified (01 Post Doctorate; 11 Doctorate; 09 PhD Pursuing) and
       dedicated faculty and staff and learner centric teaching-learning academics.
</p><br/>
<p>          Around 800 students, 12 divisions, 14 Basic Sciences, Humanities, and Engineering Sciences and 
  Foreign Languages courses is brief introduction of the department. The aim of the department is to
   mould students and start their journey as professional engineers.
</p>
<p>         
</p>
