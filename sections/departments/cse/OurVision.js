  ...
  return (
    <section className="mt-16 mx-auto flex sm:flex-col w-[1407px] sm:w-[90%] sm:mt-8">
      ...
      <div className="w-1/2 ml-12 sm:w-[100%] sm:ml-0">
        ...
        TO BE PREFERRED CHOICE OF STAKEHOLDERS BY BUILDING CORE THEORETICAL AND
         PRACTICAL SKILLS IN THE STUDENTS AND ABREAST THEM TO BE GLOBALLY COMPETENT
         WITH THE LATEST TECHNOLOGIES, SKILLS AND DEVELOPMENTS EMERGING IN THE FIELD OF COMPUTER SCIENCE AND ENGINEERING.
