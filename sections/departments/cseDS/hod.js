...
<p>        Data Science is an interdisciplinary area that extracts knowledge and insights from a variety
   of structured and unstructured data using scientific methods, procedures, algorithms, and systems.
    Data science is all about using data to solve problems. All components of technology required for
     ...
     <br /><br />The goal of this course is to generate graduates who have the theoretical understanding 
     and skill set to deal with all areas of data creation, management, processing, and conversion to knowledge.
      Students who complete the proposed programme will have a far greater depth and breadth of knowledge in the
       broad field of data science.
</p>
