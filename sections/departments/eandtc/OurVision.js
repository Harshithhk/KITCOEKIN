  ...
  return (
    <section className=" mx-auto flex sm:flex-col w-[1407px] sm:w-[90%] sm:mt-16 mb-36 sm:mb-16">
      ...
      <div className="w-1/2 ml-12 sm:w-[100%] flex flex-col items-center justify-center sm:ml-0">
        ...
        TO DEVELOP AS A CENTER OF EXCELLENCE IN ELECTRONICS & TELECOMMUNICATION ENGINEERING AND THE
         PREFERRED CHOICE OF FACULTY-STUDENTS-INDUSTRY AND SOCIETY AT GLOBAL LEVEL.
