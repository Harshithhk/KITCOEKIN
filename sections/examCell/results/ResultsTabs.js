              ...
              <div className="grid grid-rows-2 divide-y ">
                <div>
                  <Tab
                    className={({ selected }) =>
                      selected
                        ? "underline underline-offset-4 decoration-[3px] focus:outline-none font-semibold text-[#24346D] "
                        : " focus:outline-none "
                    }
                  >
                    B. Tech Results
              ...
              <Tab.Panel className="grid grid-cols-1 gap-y-2">
                <div className="pl-2 pr-2 bg-white rounded-lg shadow-lg min-h-[50px] grid grid-cols-12 items-center ">
                  <svg
                    ...
                    className="w-10 h-10 col-start-1 text-primary"
                    viewBox="0 0 20 20"
                    fill="currentColor"
                  >
                    <path
                  ...
                  <div className="col-start-2 col-end-12 sm:col-start-3">
                    APPLICATION FORM :- F.Y. B.TECH. FOUNDATION PROGRAM
                  </div>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="col-start-13  h-7 w-7 hover:text-primary hover:cursor-pointer"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                    strokeWidth="2"
