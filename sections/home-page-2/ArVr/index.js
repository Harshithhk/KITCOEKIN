                        ...
                        <div className="chn6j cbovh">
                            ...
                            <div className="c3myu ca3ts cighh cpvgl c4nun c51lg cjy67 cwayg cbum8 co2li">
                                ...
                                <div className="cgl6d c54d1 c4q7x">
                                    ...
                                    <h2 className="cpcm4 c9ob6 text-basic" data-aos="fade-up" data-aos-anchor="[data-aos-id-4]" data-aos-delay="100">See new vision</h2>
                                    <p className="c3czc cnvr3 cnfi1" data-aos="fade-up" data-aos-anchor="[data-aos-id-4]" data-aos-delay="200">Experience the latest AR-VR tech with experts, learn how to apply it to your field, build apps and games, and explore AR-VR career options.</p>
                                    ...
                                    <div className="ct5dn  cm6ll c8z22 md:flex md:items-center md:justify-center md:gap-8" data-aos="fade-up" data-aos-anchor="[data-aos-id-4]" data-aos-delay="300">
                                        <div>
                                            <h5 className="cab22 ckq42 text-basic ">Market Sectors </h5>
                                        ...
                                        <div className=''>
                                            <h5 className="cab22 ckq42 text-basic ">Technologies</h5>
                                            <ul className="cep2u c4nun czvp3 cnfi1">
                                                <li className="cighh c51lg">
                                                    <svg className="cjzor c4q7x" width="20" height="20" xmlns="http://www.w3.org/2000/svg">
                                                        <circle className="c8cq9" cx="10" cy="10" r="10"></circle>
                                ...
                                <div className="cka5y ">
                                    <div className="c3myu cka8y cemev  md:w-screen flex items-center justify-center">
                                        <img src="/images/HomePage/NewVision.jpg" className="c034o mhds:hidden cwayg md:max-w-[500px] max-w-[600px]"  alt="Features 04" data-aos="fade-up" data-aos-anchor="[data-aos-id-4]"/>
