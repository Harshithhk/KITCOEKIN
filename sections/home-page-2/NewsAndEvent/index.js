                        ...
                        <div class="chn6j cbovh">
                            ...
                            <div class="c3myu ca3ts cpvgl cjy67 cwayg co2li">
                                ...
                                <div class="ctaq8 cgmwa cjtgt" data-aos="fade-up">
                                    <h2 class="cpcm4 c9ob6 text-basic ">Stay informed about upcoming events and news</h2>
                                    <p class="ct5dn cnvr3 cnfi1 md:text-justify">Explore our Events and News Section to stay well-informed about upcoming college events, activities, and the latest news updates. Don't miss out on exciting happenings!</p>
                                </div>
                                ...
                                <div className="flex  gap-4 md:gap-y-10 md:flex-col">
                                  <div className="w-1/2 md:w-full ">
                                    <NewsAndEventsModal showModal = {showModal} setShowModal = {setShowModal} modalDetails={modalDetails} />
                                      {/* TITLE */}
                                      <h1 class="cab22 ckq42 flex gap-2 text-basic ">
