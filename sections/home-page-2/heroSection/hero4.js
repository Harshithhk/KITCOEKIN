...
<div class="relative overflow-hidden">
  <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-10">
    <div class="max-w-2xl text-center mx-auto">
      {/* <h1 class="block text-5xl font-bold text-gray-800 sm:text-4xl md:text-5xl dark:text-white">What will KITCOEK Start In  <span class="text-blue-600"></span></h1>
       */}
      <h2 class="cpcm4 c9ob6 c08o3 text-basic">What will<span class="text-primary"> KITCoEK </span> start in you</h2>
