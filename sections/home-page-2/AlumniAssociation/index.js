...
function AlumniAssociation(props) {
    return (
        <section className="c0vpr cts0y" data-aos-id-3="">
                <div className="c3myu ca3ts cbq8v">
                    ...
                    <div className="ca3ts cmc2m cuafn c0sod">
                        <div className="cfoij cah5k cdb7r">
            
                            <div className="c3myu ca3ts cighh cpvgl c4nun c51lg czaf3 cjy67 cwayg cbum8 co2li">
            
                                <div className="cgl6d c54d1 c4q7x c4zq1">
            
                                    <h2 className="cpcm4 c9ob6 text-basic" data-aos="fade-up" data-aos-anchor="[data-aos-id-3]" data-aos-delay="100">Building Lifelong Connections: The Alumni Association</h2>
                                    <p className="ct5dn cnvr3 cnfi1" data-aos="fade-up" data-aos-anchor="[data-aos-id-3]" data-aos-delay="200">The KITCoEk Alumni Association connects alumni, supports growth, and offers networking, mentorship, and career resources. Join us!</p>
                                    ...
                                    <div className="ca3ts cighh cofql cnvz4 cemev" data-aos="fade-up" data-aos-anchor="[data-aos-id-3]" data-aos-delay="300">
                                        <img className="cjzor c4q7x cp19q ct0nn" src="code/homePage/images/quote-author-02.jpg" width="32" height="32" alt="Quote author 02"/>
                                        <div>
                                            <blockquote className="cb96i cnfi1">
                                                “ The alumni association, from a student's perspective, offers inspiration and a glimpse into post-graduation possibilities. It's a valuable part of our academic journey ”
                                            </blockquote>
                                        </div>
                                    </div>
