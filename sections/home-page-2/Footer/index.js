      ...
      <footer class="bg-[#443b3c]-100 text-center text-white ">
          <div
            ...
            <div class="flex justify-center">
              <a href="#!" class="mr-6 text-white hover:cursor-pointer hover:text-orange-400  ">
                <svg
              ...
              <a href="#!" class="text-white md:text-sm hover:cursor-pointer hover:text-orange-400 ">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="h-4 w-4"
                  fill="currentColor"
          ...
          <div class="px-6 py-10 bg-[#443b3c] text-center md:text-left">
