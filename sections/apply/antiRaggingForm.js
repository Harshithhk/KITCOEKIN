    ...
    <div className="mt-5 sm:mt-0 col-span-2 sm:col-span-3">
        ...
        <div className="shadow overflow-hidden sm:rounded-md">
          ...
          <div className="col-span-6 sm:col-span-3">
              ...
              <div>
              <label for="about" className="contents text-base font-medium text-gray-900"> Permanent Address * </label>
              <div className="mt-1">
                <textarea id="about" name="about" rows="3" className="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md" placeholder="Enter Address"></textarea>
              </div>
              {/* <p className="mt-2 text-sm text-gray-500">Brief description for your requirement. URLs are hyperlinked.</p> */}
            </div>
  
            <fieldset>
              <legend className="contents text-base font-medium text-gray-900">Presently residing at *</legend>
              ...
              <div className="mt-4 md:space-y-4 2xl:space-y-0 grid 2xl:grid-cols-6 md:grid-cols-1 ">
                <div className="flex items-center">
                  ...
                  <label for="push-everything" className="ml-3 block text-sm font-medium text-gray-700"> College Hostel </label>
                </div>
                <div className="flex items-center">
                  ...
                  <label for="push-email" className="ml-3 block text-sm font-medium text-gray-700"> Private hostel </label>
                </div>
                <div className="flex items-center">
                  ...
                  <label for="push-nothing" className="ml-3 block text-sm font-medium text-gray-700"> Others   </label>
                </div>
                
              </div>
            </fieldset>
            <div>
              <label for="about" className="contents text-base font-medium text-gray-900"> Complaint Against * </label>
              <div className="mt-1">
                <textarea id="about" name="about" rows="3" className="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md" placeholder="Enter Complaint Against"></textarea>
              </div>
              {/* <p className="mt-2 text-sm text-gray-500">Brief description for your requirement. URLs are hyperlinked.</p> */}
            </div>
            <div>
