  ...
  return (
    <section className="overflow-hidden text-gray-700 ">
      ...
      <div className="container px-2 sm:hidden 2xl:block">
        {/*  */}
        <div className="flex flex-wrap -m-1 sm:flex-col ">
          {/*  */}
          <div className="flex flex-wrap w-full sm:w-fit">
            <div className=" w-3/5 sm:w-full sm:p-0 h-[401px]   p-3 ">
              <img
                alt="gallery"
                className="block object-cover object-center w-full h-full shadow-lg rounded-3xl"
          ...
          <div className="flex flex-wrap w-1/6 sm:w-fit ">
            <div className="w-full sm:w-full  sm:p-0  h-[294px]   p-3 ">
              <div className=" h-full bg-[#3D3859] rounded-3xl flex items-center ">
                <div className="p-5 text-4xl italic font-bold text-justify text-white ">
                  <p className="p-1 underline">See more</p>
                  <p className="p-1 underline"> what's in</p>{" "}
        ...
        <div className="flex flex-wrap -m-1 ">
          ...
          <div className="flex flex-wrap ">
            <div className="w-4/6 p-1 ">
              <img
                alt="gallery"
                className="block object-cover object-center w-full shadow-lg rounded-3xl "
                src="images/LifeAtKit/1.jpg"
              />
            </div>
            <div className="w-2/6 p-1 ">
              <div className="  bg-[#3D3859] rounded-3xl h-full flex items-center shadow-lg  ">
                <div className="p-5 text-sm italic font-bold text-justify text-white ">
                  <p className="p-1 underline">See more</p>
                  <p className="p-1 underline"> what's in</p>{" "}
                  <p className="p-1">here &#x27A5;</p>
                </div>
