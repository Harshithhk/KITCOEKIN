...
const MissionCards = () => {
  return (
    <section className="mt-[230px] flex flex-wrap mx-auto gap-y-14 justify-between w-[1083px] sm:w-auto px-3 sm:p-0 sm:mt-8 min-h-[165px]">
      ...
      <div className="w-[500px] h-auto bg-[#FEF6ED] px-9 py-10 rounded-[36px] relative sm:w-[165px] sm:h-fit sm:p-3 sm:rounded-xl min-h-[215px]">
        ...
        <div className="mt-5 text-xl sm:text-xs sm:mt-1">
          To develop competence towards serving the ever changing needs of
          Industry & society <br />
          <br />
        </div>
      </div>
      ...
      <div className="w-[500px] h-auto bg-[#FEF6ED] px-9 py-10 rounded-[36px] relative sm:w-[165px] sm:h-fit sm:p-3 sm:rounded-xl min-h-[215px]">
        ...
        <div className="mt-5 text-xl sm:text-xs sm:mt-1">
          To strengthen collaborative research and consulting environment with
          Industry and other Institution <br />
          <br />
        </div>
      </div>
    </section>
