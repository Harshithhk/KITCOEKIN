...
const ManditoryDisclosure20 = () => {
  let governingCouncilList = [
    ...
    },
    {
      ...
      Designation:
        "Chief Technology Officer, Strategic Electronic Division(SED), Tata Power Company Ltd, MUMBAI",
    ...
    },
    {
      ...
      Name: "Dr.Anand Mohan",
      Designation:
        "Professor, Dept. Electronics Engg,Indian Institute of Technology, Banaras Hindu University, Varanasi",
    ...
    },
    {
      ...
      Name: "Dr. C.S. Verma",
      Designation:
        "Regional Officer & Assistant Director (WRC) AICTE, Churchgate, Mumbai.",
    ...
    },
    {
      ...
      Designation:
        "Professor, Dept. of Electronics Engineering Kolhapur Institute of Technology's College of Engg. (Autonomous), Kolhapur",
    ...
    },
    {
      ...
      Designation:
        "Associate Professor, Dept. of Information Technology Kolhapur Institute of Technology's College of Engg. (Autonomous), Kolhapur",
    ...
    },
    {
      ...
      Designation:
        "Registrar, Kolhapur Institute of Technology's College of Engg. (Autonomous), Kolhapur",
    ...
    },
    {
      ...
      Designation:
        "Director, Kolhapur Institute of Technology's College of Engg. (Autonomous), Kolhapur",
    ...
    <DefaultLayout>
      <div className="w-full ">
        ...
        <section className="overflow-x-scroll max-w-screen">
          <section className="relative z-30 w-[1500px] md:w-full pb-20 mx-auto h-fit px-14 sm:px-4 sm:pb-10  ">
            <div className=" items-center md:w-full w-[800px] mx-auto h-fit p-2 mt-6 font-semibold text-center rounded-lg shadow-lg ">
              <div className="flex mt-2 mb-2">
                <div className=" w-[50%] text-left pl-2 text-slate-400">
                  {" "}
            ...
            <div className=" items-center mx-auto md:w-full w-[800px] h-fit p-2 mt-6 font-semibold text-center rounded-lg shadow-lg ">
              <div className="flex mt-2 mb-2">
                <div className=" w-[50%] text-left pl-2 text-slate-400">
                  Name of the Trust
                </div>
