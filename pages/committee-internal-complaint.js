...
import InternalComplainForm from "../sections/apply/internalComplainForm"
...
const StaffCommittee = () => {
  let Committee = [
    {
      "Sr.No": 1,
      "Name": "Dr. (Mrs.) T. S. Desai",
      "Designation": "Associate Professor in Physics,\nDept. of Basic Science & Humanities\nKIT's College of Engg. (Autonomous), Kolhapur \nEmail ID : tejaswinidesai@yahoo.co.in\nMob. No. :9421200644",
      "Position": "Chairperson"
    },
    {
      "Sr.No": 2,
      "Name": "Dr. Dattatray J. Sathe",
      "Designation": "Associate Professor in Chemistry,\nDept. of Basic Science & Humanities\nKIT's College of Engg. (Autonomous), Kolhapur\nEmail ID : sathedj_kit@rediffmail.com\nMob. No. : 9421104456",
      "Position": "Member - Faculty"
    },
    {
      "Sr.No": 3,
      "Name": "Mrs. Mamata S. Kalas",
      "Designation": "Associate Professor,\nKIT's College of Engg. (Autonomous), Kolhapur\nEmail ID : mam2kalas@rediffmail.com\nMob. No. : 9767865732",
      "Position": "Member - Faculty"
    },
    {
      "Sr.No": 4,
      "Name": "Smt. Smita S. Kulkarni",
      "Designation": "Sr. Clerk,\nKKIT's College of Engg. (Autonomous), Kolhapur\nEmail ID : smidehi@yahoo.Com\nMob. No. : 9766644017",
      "Position": "Member - Non-Teaching"
    },
    {
      "Sr.No": 5,
      "Name": "Mrs. Tanuja N. Shipurkar",
      "Designation": "Secretary of an NGO working for women's Welfare,\nMahila Dakshta Samiti.\n.Mob. No. : 9370323032",
      "Position": "Member - NGO"
    },
    {
      "Sr.No": 6,
      "Name": "Ms. Angela Bandi",
      "Designation": "Student, M.Tech",
    ...
    <DefaultLayout>
      <div className="w-full ">
        <section className="flex flex-col h-[250px] items-center w-full relative">
          ...
          >
            <span className="hover:text-primary hover:cursor-pointer"> Home</span> <span className=" ">|</span> Internal Complaint Committee 
          </h6>
        </section>
        {/*-------------------------------------------------------------------------------------- CONTENT -------------------------------------------------------------------------------------- */}
