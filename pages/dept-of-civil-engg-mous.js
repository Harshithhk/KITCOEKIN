                            ...
                            {Mous.map((item, index) => {
                                return (
                                    ...
                                    <div key = {index} className="sm:hidden grid grid-cols-8 items-center justify-items-start gap-x-2 sm:gap-x-2 w-full h-fit overflow-x-auto sm:h-fit p-2 mt-2 shadow-lg rounded-2xl bg-white">
                                        ...
                                        <div className=" sm:grid 3xl:hidden 2xl:hidden divide-y grid-rows-8 space-x-[1px] items-center text-left  w-full h-fit overflow-x-auto sm:h-fit p-2 mt-2 shadow-lg rounded-2xl bg-white">
