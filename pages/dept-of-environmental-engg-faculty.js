...
export async function getStaticProps() {
  let staff = []
  staff = await fetch(process.env.SERVER_API+"/api/teachingstaff?department=Civil And Environmental Engineering")
...
const EnvironmentalEngineeringFaculty = ({ staff }) => {
...
export default EnvironmentalEngineeringFaculty
