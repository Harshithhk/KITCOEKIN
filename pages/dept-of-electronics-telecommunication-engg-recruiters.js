...
const EntcEngineeringRecruiters = () => {
    let Recruiters = [
        {
          "SrNo": "1",
          "Recruiters": "KPIT Technologies"
        },
        {
          "SrNo": "2",
          "Recruiters": "Capegemini"
        },
        {
          "SrNo": "3",
          "Recruiters": "Cognizant"
        },
        {
          "SrNo": "4",
          "Recruiters": "Elcome Marine"
        },
        {
          "SrNo": "5",
          "Recruiters": "Global Edge"
        },
        {
          "SrNo": "6",
          "Recruiters": "Tata Consultancy"
        },
        {
          "SrNo": "7",
          "Recruiters": "Crust Test TECH"
        },
        ...
        <DefaultLayout>
            <div className="w-full ">
                <section className="flex flex-col h-[250px] items-center w-full relative">
                    ...
                    >
                        Electronics & Telecommunication Recruiters
                    </h1>
                    <br></br>
                    <br></br>
                    <h6
...
export default EntcEngineeringRecruiters
