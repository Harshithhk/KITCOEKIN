...
const EntcEngineeringLaboratories = () => {
    let Laboratories = [{
		"SrNo": 1,
		"SubCriteria": "Analog Electronics",
		"Area": 71.67
	},{
		"SrNo": 2,
		"SubCriteria": "Antenna & Microwave Engineering",
		"Area": 67.68
	},{
		"SrNo": 3,
		"SubCriteria": "Power Electronics",
		"Area": 66.42
	},{
		"SrNo": 4,
		"SubCriteria": "Design & Project",
		"Area": 60.93
	},{
		"SrNo": 5,
		"SubCriteria": "Communication Engineering I",
		"Area": 78.15
	},{
		"SrNo": 6,
		"SubCriteria": "Process Control and Measurement",
		"Area": 66.42
	},{
		"SrNo": 7,
		"SubCriteria": "Computer Facility",
		"Area": 80.00
	},{
		"SrNo": 8,
		"SubCriteria": "Embeded Systems",
		"Area": 71.67
	},{
		"SrNo": 9,
		"SubCriteria": "Communication Engineering II",
		"Area": 67.68
	}
]
        ...
        <DefaultLayout>
            <div className="w-full ">
                <section className="flex flex-col h-[250px] items-center w-full relative">
                    ...
                    >
                        Electronics & Telecommunication Laboratories
                    </h1>
                    <br></br>
                    <br></br>
                    <h6
                ...
                <section className="col-start-1  col-end-3 sm:mr-0 sm:ml-0 sm:mt-6 sm:px-4 sm:pb-10  pb-20 mx-10  h-fit   ">
                            ...
                            <div className="sm:hidden grid grid-cols-3 items-center text-slate-500 justify-items-start mt-6  w-full h-16 sm:h-16 p-2 mb-6 shadow-lg rounded-2xl">
                                ...
                                <div className=" ">Sub Criteria</div>
                                ...
                                return (
                                    <>
                                        <div className="sm:hidden grid grid-cols-3 items-center justify-items-start gap-x-5 sm:gap-x-2 w-full h-fit overflow-x-auto sm:h-fit p-2 mt-2 shadow-lg rounded-2xl bg-white">
                                            ...
                                            <div className="">{item.SubCriteria}</div>
                                        ...
                                        <div className=" sm:grid 2xl:hidden divide-y grid-rows-3 items-center text-left  w-full h-fit overflow-x-auto sm:h-fit p-2 mt-2 shadow-lg rounded-2xl bg-white">
                                            ...
                                            <div className="grid grid-cols-2">
                                                <div className=" text-slate-400">Sub Criteria</div>
                                                <div className="">{item.SubCriteria}</div>
                                            </div>
                                            <div className="grid grid-cols-2">
...
export default EntcEngineeringLaboratories
