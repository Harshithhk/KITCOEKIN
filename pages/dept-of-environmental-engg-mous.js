...
const EnviromentalEngineeringMous = () => {
    let Mous = [{
        "SrNo": 1,
        "Industry": "Dnyandeep Infotech Pvt. Ltd., Sangli",
        "DateOfMOU": "17/04/2004"
      },{
        "SrNo": 2,
        "Industry": "M/S. Enviclean Associates, Kolhapur",
        "DateOfMOU": "18/07/2006"
      },{
        "SrNo": 3,
        "Industry": "Institute of Indian Foundryman,Kolhapur Local Chapter",
        "DateOfMOU": "23/11/2007"
      },{
        "SrNo": 4,
        "Industry": "M/s Aquatech, Pune",
        "DateOfMOU": "02/01/2014"
      },{
        "SrNo": 5,
        "Industry": "Primove, Infrastructure Development consultants, Pvt Ltd. Pune",
        "DateOfMOU": "30/08/2014"
      },{
        "SrNo": 6,
        "Industry": "Gharpure Engineering and Construction Pvt. Ltd. ,Pimpri – Chinchwad",
        "DateOfMOU": "17/04/2015"
      },{
        "SrNo": 7,
        "Industry": "M/S. Equinox India Pvt Ltd, Kolhapur",
        "DateOfMOU": "April, 2018"
      },{
        "SrNo": 8,
        "Industry": "National Institute of Urban Affairs (NIUA), New Delhi",
        "DateOfMOU": "01/10/2018"
      }
      ]
        ...
        <DefaultLayout>
            <div className="w-full ">
                <section className="flex flex-col h-[250px] items-center w-full relative">
                    ...
                    >
                        Civil & Environmental Engineering MOU'S
                    </h1>
                    <br></br>
                    <br></br>
                    <h6
                            ...
                            {Mous.map((item, index) => {
                                return (
                                    <>
                                        ...
                                        <div className=" sm:grid 3xl:hidden 2xl:hidden divide-y grid-rows-3 space-x-[1px] items-center text-left  w-full h-fit overflow-x-auto sm:h-fit p-2 mt-2 shadow-lg rounded-2xl bg-white">
...
export default EnviromentalEngineeringMous
