...
const StudentClubActivities = () => {
    ...
    let SrcList = [
        {
          "src":"images/IdeaLab/th-proposed-image-03.jpg"
        },
        {
          "src":"images/IdeaLab/proposed-image-02.jpg"
        },
        {
          "src":"images/IdeaLab/proposed-image-01.jpg"
        },
        {
          "src":"images/IdeaLab/proposed-image-04.jpg"
        },
        {
            "src":"images/IdeaLab/proposed-image-05.jpg"
          },
      ]
  return (
    <DefaultLayout>
      <div className="w-full bg-[#24346D]">
        <section className="flex flex-col h-[250px] items-center w-full relative">
          ...
          <h1
                    ...
                    >
                        <span className="hover:text-primary hover:cursor-pointer"> Home</span> <span className=" ">|</span> LAYOUT
                    </h6>
        </section>
