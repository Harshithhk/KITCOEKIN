...
const EquipmentCommittee = () => {
  let Committee = [
	...
	{
	  "Sr.No": 7,
	  "Name & Address": "Col. (Retd.) Pratapsinh Raorane\n“Sarojkunj” , 1910 E,Rajarampuri ,11th Lane,KOLHAPUR - 416 006\nMob. No. 9243700585\nEmail ID - pratapraorane@gmail.com",
	  "Designation": "Trustee",
	  "Affiliation": "Head,Software Quality Assurance,Tata Power Strategic Engg.Division, B’lore."
	}
   ]
  return (
    <DefaultLayout>
      <div className="w-full ">
        <section className="flex flex-col h-[250px] items-center w-full relative">
          ...
          >
            <span className="hover:text-primary hover:cursor-pointer"> Home</span> <span className=" ">|</span> Equipment Committee 
          </h6>
        </section>
        {/*-------------------------------------------------------------------------------------- CONTENT -------------------------------------------------------------------------------------- */}
          ...
          <div className="sm:hidden grid grid-cols-4 sm:grid-cols-7 items-center text-slate-500 justify-items-center mt-6  w-full h-16 sm:h-16 p-2 mb-6 shadow-lg rounded-2xl">
            ...
            {Committee.map((item, index) => {
               return (
                ...
                <div className=" sm:grid 3xl:hidden 2xl:hidden divide-y gap-y-2 grid-rows-1 items-center text-left  w-full h-fit overflow-x-hidden sm:h-fit p-2 mt-2 shadow-lg rounded-2xl bg-white">
