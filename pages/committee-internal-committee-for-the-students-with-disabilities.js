...
const StaffCommittee = () => {
  let Committee = [
    ...
    },
    {
      ...
      "Designation": "Asst. Prof.\nDept. of Production Engineering,\nKIT's College of Engg. (Autonomous), Kolhapur\nEmail ID : hah.shailesh@kitcoek.in\nMob. No. : 9850116463",
      "Position": "Member-Faculty."
    },
    {
      "Sr.No": 4,
      "Name": "Mrs. Jahida N. khan",
      "Designation": "Asst. Prof.\nDept. of Mechanical Engineering,\nKIT's College of Engg. (Autonomous), Kolhapur\nEmail ID :han.jahida@kitcoek.in\nMob. No. : 9922649594",
      "Position": "Member-Faculty."
    },
    {
      "Sr.No": 5,
      "Name": "Mr. Pandurang. S. Patil",
      "Designation": "Lab Technician,\nDept. of Civil Engineering,\nKIT's College of Engg. (Autonomous), Kolhapur\nEmail ID : spatil759@gmail.com\nMob. No. : 9422620960",
      "Position": "Member-Staff."
    },
    {
      "Sr.No": 6,
      "Name": "Mr.Tambe Vishwa Vijay",
      "Designation": "Student, D.S. (Mechanical Engineering.)\nDept. of Information Technology,\nKIT's College of Engg. (Autonomous), Kolhapur\nEmail ID : tambevishwa@gmail.com\nMob. No. : 9307671093",
      "Position": "D.S. (Mech) Member-Student"
    },
    {
      "Sr.No": 7,
      "Name": "Mr.Patil Jyotiraditya Shivaji",
      "Designation": "Student, F.Y.B.Tech. (Computer Sci. & Engineering.)\nKIT's College of Engg. (Autonomous), Kolhapur\nEmail ID : ar.neelpatil@gmail.com\nMob. No. : 9420622303",
      "Position": "F.Y. B.Tech(CSE)Member-Student."
    },
    {
      "Sr.No": 8,
    ...
    <DefaultLayout>
      <div className="w-full ">
        <section className="flex flex-col h-[250px] items-center w-full relative">
          ...
          >
            <span className="hover:text-primary hover:cursor-pointer"> Home</span> <span className=" ">|</span> Internal Committee for the Students with Disabilities 
          </h6>
        </section>
        {/*-------------------------------------------------------------------------------------- CONTENT -------------------------------------------------------------------------------------- */}
