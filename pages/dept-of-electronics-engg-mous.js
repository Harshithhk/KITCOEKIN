...
const ElectronicssEngineeringMous = () => {
    let Mous = [{
		"SrNo": 1,
		"Industry": "KPIT Technologies, Pune"
	},{
		"SrNo": 2,
		"Industry": "Microlog Systems"
	},{
		"SrNo": 3,
		"Industry": "Domain Computers"
	}
]
        ...
        <DefaultLayout>
            <div className="w-full ">
                ...
                <section className="col-start-1  col-end-3 sm:mr-0 sm:ml-0 sm:mt-6 sm:px-4 sm:pb-10  pb-20 mx-10  h-fit   ">
                            ...
                            {/* -------------- */}
                            <div className="sm:hidden grid grid-cols-2 items-start gap-x-2 text-slate-500 justify-items-start mt-6  w-full h-16 sm:h-16 p-2 mb-6 shadow-lg rounded-2xl">
                            ...
                            {Mous.map((item, index) => {
                                return (
                                    <>
                                        <div className="sm:hidden grid grid-cols-2 items-center justify-items-start gap-x-2 sm:gap-x-2 w-full h-fit overflow-x-auto sm:h-fit p-2 mt-2 shadow-lg rounded-2xl bg-white">
...
export default ElectronicssEngineeringMous
