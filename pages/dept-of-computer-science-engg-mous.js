                            ...
                            {Mous.map((item, index) => {
                                return (
                                    <>
                                        ...
                                        <div className=" sm:grid 3xl:hidden 3xl:hidden 2xl:hidden divide-y grid-rows-3 space-x-[1px] items-center text-left  w-full h-fit overflow-x-auto sm:h-fit p-2 mt-2 shadow-lg rounded-2xl bg-white">
