            ...
            <div>
              ...
              <div className=" items-center  w-[650px] h-fit p-2 mt-6 font-semibold text-center rounded-lg  bg-[#F8F7FC]">
                               <div className="flex mt-2 mb-2">
                                    <div className=" w-[25%] text-left pl-2 text-[#24346D]">First Year B. Tech</div>
                                </div>
                                ...
                                <div className=" items-center  w-auto h-[63px] p-2 mt-2 font-semibold text-center rounded-lg shadow-lg bg-[#ffffff]">
                                    ...
                                    <img
                                        ...
                                        alt=""
                                    />
                                        <div className=" w-[100%] mt-1 text-left pl-2 ml-2 text-[#24346D]">APPLICATION FORM :- F.Y. B.TECH. FOUNDATION PROGRAM</div>
                                        <img
              ...
              <div className=" items-center  w-[650px] h-fit p-2 mt-6 ml-6 font-semibold text-center rounded-lg  bg-[#F8F7FC]">
                                <div className="flex mt-2 mb-2">
                                    <div className=" w-[25%] text-left pl-2 text-[#24346D]">Direct Second Year</div>
                                </div>
                               ...
                               <div className="flex mt-2 mb-2">
                                ...
                                <div className=" items-center  w-auto h-[63px] p-2 mt-2 font-semibold text-center rounded-lg shadow-lg bg-[#ffffff]">
                                    ...
                                    <img
                                        ...
                                        alt=""
                                    />
                                        <div className=" w-[100%] mt-1 text-left pl-2 ml-2 text-[#24346D]">Last Year Cutoff [Male] AY:2021-22</div>
                                        <img
                                        src="/images/Others/download-file.png"
                                        className="w-8 h-8 mr-2 "
                                        alt=""
                                ...
                                <div className=" items-center  w-auto h-[63px] p-2 mt-2 font-semibold text-center rounded-lg shadow-lg bg-[#ffffff]">
                                    ...
                                    <img
                                        ...
                                        alt=""
                                    />
                                        <div className=" w-[100%] mt-1 text-left pl-2 ml-2 text-[#24346D]">Last Year Cutoff [Female] AY:2021-22</div>
                                        <img
                                        src="/images/Others/download-file.png"
                                        className="w-8 h-8 mr-2 "
                                        alt=""
                                ...
                                <div className=" items-center  w-auto h-[63px] p-2 mt-2 font-semibold text-center rounded-lg shadow-lg bg-[#ffffff]">
                                    ...
                                    <img
                                        ...
                                        alt=""
                                    />
                                        <div className=" w-[100%] mt-1 text-left pl-2 ml-2 text-[#24346D]">Fee Structure</div>
                                        <img
                                        src="/images/Others/download-file.png"
                                        className="w-8 h-8 mr-2 "
                                        alt=""
...
<div className="flex justify-between sm:flex-col">
                               ...
                               <div className="flex mt-2 mb-2">
                                ...
                                <div className=" items-center  w-auto h-[63px] p-2 mt-2 font-semibold text-center rounded-lg shadow-lg bg-[#ffffff]">
                                    ...
                                    <img
                                        ...
                                        alt=""
                                    />
                                        <div className=" w-[100%] mt-1 text-left pl-2 ml-2 text-[#24346D]">Scholarships Schemes Offered by State Govt. / Central Govt.</div>
                                        <img
                                        src="/images/Others/download-file.png"
                                        className="w-8 h-8 mr-2 "
                                        alt=""
                                ...
                                <div className=" items-center  w-auto h-[63px] p-2 mt-2 font-semibold text-center rounded-lg shadow-lg bg-[#ffffff]">
                                    ...
                                    <img
                                        ...
                                        alt=""
                                    />
                                        <div className=" w-[100%] mt-1 text-left pl-2 ml-2 text-[#24346D]">F. Y B. Tech Fee Structure for Academic Year 2021-22</div>
                                        <img
                                        src="/images/Others/download-file.png"
                                        className="w-8 h-8 mr-2 "
                                        alt=""
    ...
    <section className="pt-16 mt-16 mb-[-60px] overflow-x-scroll  bg-[#F8F7FC] max-w-screen">
      ...
      <section className="relative   z-30 w-[1500px] pb-20 mx-auto h-fit px-14  sm:px-4 sm:pb-10 sm:w-[1000px]">
        ...
        <div className="flex items-center w-full h-16 p-2 mt-2 text-center shadow-lg rounded-2xl bg-white">
          <div className=" w-[60%] text-left pl-2 "><p className="text-[#24346D]">Bio-Technology Engineering</p> <p className="text-[#F07C00]"> B.Tech (Hons.) Civil & Environmental Engineering with specialization in Green Technology & Sustainability Engineering</p></div>
          <div className=" w-[10%] text-left pl-2">17</div>
          <div className=" w-[10%] text-left pl-2">25</div>
          <div className=" w-[10%] text-left pl-2">29</div>
          <div className=" w-[10%] text-left pl-2">29</div>
      ...
      <div className="flex   w-[1100px] ml-[110px] h-fit p-2 mt-6 font-semibold text-center rounded-lg shadow-lg bg-white ">
                               ...
                               <div className="mr-6 w-[65%]" >
                                    <div className="flex mt-2 mb-2">
                                          <div className=" w-[50%]  pl-2 "><p>Dr. Mahesh B. Shinde</p><p className="text-slate-400">Assistant Professor</p></div>
                                          <div className=" ml-[110px]  pl-2 ">		
                                          <p><span className="text-slate-400">Mobile :</span> 7030861199</p><p className="ml-16">9767873887</p>
                                          </div>
                                    </div>
                                    <hr></hr>   
                                    <div className="flex mt-2 mb-2">
                                        <div className=" w-[50%]  pl-2 "><p>Mr. Saurabh S. Joshi</p><p className="text-slate-400">Assistant Professor</p></div>
                                        <div className=" ml-[110px]  pl-2 ">		
                                          <p><span className="text-slate-400">Mobile :</span> 9028486124</p>
                                        </div>
                                    </div>
                                    <hr></hr> 
                                    <div className="flex mt-2 mb-2">
                                        <div className=" w-[50%]  pl-2 "><p>Mr. Amar H. Tikole</p><p className="text-slate-400">Assistant Professor</p></div>
                                        <div className=" ml-[110px]  pl-2 ">		
                                          <p><span className="text-slate-400">Mobile :</span> 9272319199</p>
                                        </div>
                                    </div>
                                    <hr></hr> 
                                    <div className="flex mt-2 mb-2">
                                        <div className=" w-[50%]  pl-2 "><p>Dr. Nivas S. Patil</p><p className="text-slate-400">Assistant Professor</p></div>
                                        <div className=" ml-[110px]  pl-2 ">		
                                          <p><span className="text-slate-400">Mobile :</span>  9158337227</p>
                                        </div>  
                                    </div>
      ...
      <div className="flex   w-[1100px] ml-[110px] h-fit p-2 mt-2 font-semibold text-center rounded-lg shadow-lg bg-white ">
                               ...
                               <div className="mr-6 w-[65%]" >
                                    <div className="flex mt-2 mb-2">
                                          <div className=" w-[50%]  pl-2 "><p>Dr. Rajesh M. Jorgewad</p><p className="text-slate-400">Assistant Professor</p></div>
                                          <div className=" ml-[110px]  pl-2 ">		
                                          <p><span className="text-slate-400">Mobile :</span>  8668406496</p>
                                        </div>
                                    </div>
                                    <hr></hr>   
                                    <div className="flex mt-2 mb-2">
                                        <div className=" w-[50%]  pl-2 "><p>Mrs. Saee H. Thakur</p><p className="text-slate-400">Assistant Professor</p></div>
                                        <div className=" ml-[110px]  pl-2 ">		
                                          <p><span className="text-slate-400">Mobile :</span>  9850317278</p>
                                        </div>
                                    </div>
      ...
      <div className="flex   w-[1100px] ml-[110px] h-fit p-2 mt-2 font-semibold text-center rounded-lg shadow-lg bg-white ">
                               <div className="w-[35%] mt-2">Civil and Environmental
Engineering</div>
                               <div className="mr-6 w-[65%]" >
                                    <div className="flex mt-2 mb-2">
                                          <div className=" w-[50%]  pl-2 "><p>Dr. Akshay R. Thorvat</p><p className="text-slate-400">Assistant Professor</p></div>
                                          <div className=" ml-[110px]  pl-2 ">		
                                          <p><span className="text-slate-400">Mobile :</span>  9175886755</p>
                                        </div>
                                    </div>
                                    <hr></hr>   
                                    <div className="flex mt-2 mb-2">
                                        <div className=" w-[50%]  pl-2 "><p>Mr. Bharat C. Ingavale</p><p className="text-slate-400">Assistant Professor</p></div>
                                        <div className=" ml-[110px]  pl-2 ">		
                                          <p><span className="text-slate-400">Mobile :</span>  9823644466</p>
                                        </div>
                                    </div>
