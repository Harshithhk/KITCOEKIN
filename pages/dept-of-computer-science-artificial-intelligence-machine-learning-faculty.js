...
import QuickLinksCard from "../sections/departments/cseAIML/career/quickLinksCard"
...
export async function getStaticProps() {
  let staff = []
  staff = await fetch(process.env.SERVER_API+"/api/teachingstaff?department=Computer Sci. And Engg. [AI/ML]")
...
const CseAiMlEngineeringFaculty = ({ staff }) => {
...
export default CseAiMlEngineeringFaculty
