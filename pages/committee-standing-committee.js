  ...
  let Committee = [
    {
      ...
      "Designation": "Director, KIT's College of Engg. (Autonomous), Kolhapur\nEmail ID- mohan1.bv@gmail.com\nMobile No. 9902544599",
      "Position": "Chairman"
    },
    {
      "Sr.No": 2,
    ...
    {
      "Sr.No": 3,
      "Name": "Dr. Sunil S. Shaha",
      "Designation": "Associate Professor,\nDept. of Environmental Engg. KIT's College of Engg. (Autonomous), Kolhapur\nEmail ID : sunil.shaha@gmail.com\nMob. No. : 9850114643",
      "Position": "Member, Nominee, Faculty"
    },
    {
      "Sr.No": 4,
      "Name": "Dr.N.B.Sambre",
    ...
    },
    {
      ...
      "Designation": "Associate Professor,\nDept. of Mechanical Engg. KIT's College of Engg. (Autonomous), Kolhapur\nEmail ID : satarasachin@gmail.com\nMob. No. : 9049506311",
      "Position": "Member, Nominee, Faculty"
    },
    {
      "Sr.No": 6,
      "Name": "Mrs. Uma P. Gurav",
      "Designation": "Associate Professor, Dept. of Computer Science & Engg.\nKIT's College of Engg. (Autonomous), Kolhapur\nEmail ID : umabgurav@yahoo.co.in\nMob. No. : 9867277931",
      "Position": "Member, Nominee, Faculty"
    },
    {
      "Sr.No": 7,
      "Name": "Mr. Sanjay S. Gavade",
      "Designation": "Lab Assistant,\nDept. of Production Engg.\nKIT's College of Engg. (Autonomous), Kolhapur\nEmail ID : sanjaygavade123@rediffmail.com\nMob. No. : 9890952260",
      "Position": "Member, Nominee, Non-Teaching Staff"
    },
    {
      "Sr.No": 8,
      "Name": "Mr.Rajaram S. More",
      "Designation": "Lab Assistant,\nDept. of Mechanical Engg.\nKIT's College of Engg. (Autonomous), Kolhapur\nEmail ID : more.rajaram@kitcoek.in\nMobile No.",
      "Position": "Member Nominee, Non-Teaching Staff"
    },
    {
      "Sr.No": 9,
      "Name": "Mrs.Anupama A.Sawant",
      "Designation": "Sr. Clerk,\nCentral Library,\nKIT's College of Engg. (Autonomous), Kolhapur\nEmail ID : savanta1997@gmail.com\nMob. No. : 9423816228, 7276671154",
      "Position": "Member-Secretary Nominee, Non-Teaching Staff (Women)"
    }
   ]
  return (
    <DefaultLayout>
      <div className="w-full ">
        <section className="flex flex-col h-[250px] items-center w-full relative">
          ...
          >
            <span className="hover:text-primary hover:cursor-pointer"> Home</span> <span className=" ">|</span> Standing Committee 
          </h6>
        </section>
        {/*-------------------------------------------------------------------------------------- CONTENT -------------------------------------------------------------------------------------- */}
