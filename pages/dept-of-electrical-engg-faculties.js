...
export async function getStaticProps() {
  let staff = []
  staff = await fetch(process.env.SERVER_API+"/api/teachingstaff?department=Electrical Engineering")
...
const ElectricalEngineeringFaculty = ({ staff }) => {
...
export default ElectricalEngineeringFaculty
