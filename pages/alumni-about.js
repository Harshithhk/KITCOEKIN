...
import OurVision from "../sections/alumni/OurVision"
import AboutUs from "../sections/alumni/AboutUs"
import MissionCards from "../sections/alumni/MissionCards"
      ...
      <div className="relative w-full">
        ...
        <section className="relative flex flex-col items-center w-full">
          ...
          <img
            ...
            alt=""
          />
          <div className="absolute w-full h-[870px] top-0 left-0 bg-[#24346D] z-0"></div>
          ...
          ><a href="alumni">
            ...
            <span className="">|</span> About Alumni Association
          </h6>

     
        </section>
        
        <section className="relative rounded-3xl z-30 w-[95%] mx-auto mt-16 pb-20 h-fit  bg-white px-14 sm:px-4 sm:pb-10">
